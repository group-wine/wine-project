...
kable(lmresults, caption = "Comparison of Full and Reduced Linear Regression Models for Red and White Wine Quality", booktabs=T,digits = 4) %>%
...
* No clear winner - so linear regression wins!
